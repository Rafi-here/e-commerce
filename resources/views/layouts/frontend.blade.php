            ...
            <div class="container-fluid">
                <div class="furniture-bottom-wrapper">
                    <div class="furniture-login">
                        <ul>
                            @guest
                            <li>Login dulu : <a href="{{ route('login') }}">Login</a></li>
                    ...
                    <div class="furniture-search">
                        <form>
                            <input placeholder="Cari produk disini . . ." type="text" name="q" autocomplete="off" id="search">
                            <button disabled>
                                <i class="ti-search"></i>
                            </button>
                        </form>
                        ...
                        <div class="footer-info-wrapper-3">
                            <div class="footer-address-furniture">
                                ...
                                <div class="footer-info-content3">
                                    <p>West Java, Indonesian <br>IND- 02889</p>
                                </div>
                            </div>
                            <div class="footer-address-furniture">
                                <div class="footer-info-icon3">
                                ...
                                <div class="footer-info-content3">
                                    <p>+62 8123456789 <br>+62 8822334455</p>
                                </div>
                            </div>
                            <div class="footer-address-furniture">
                                <div class="footer-info-icon3">
                                ...
                                <div class="footer-info-content3">
                                    <p><a href="#"> admin@domain.com</a> <br><a href="#"> admin@mail.info</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="copyright-furniture">
                            <p>Copyright © <a href="https://portfolio-rafi-heres-projects.vercel.app/">Piwcoders</a> 2025 . All Right Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            $('#search').typeahead({
                ...
                templates: {
                    ...
                    suggestion: function(data) {
                        // Ambil base URL dari Blade
                        const baseUrl = "{{ url('product') }}";

                        function generateItem(data) {
                            return '<div style="font-weight:normal; width:100%" class="list-group-item">' +
                                '<a href="' + baseUrl + '/' + data.slug + '">' + data.name + '</a>' +
                                '</div>';
                        }
                    }
                }
